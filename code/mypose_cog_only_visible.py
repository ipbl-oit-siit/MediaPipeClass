...
def draw_cog_point_of_only_basic_points(image, Pose):
    for id_pose in range(Pose.num_detected_poses): # all poses
        ...
        cv2.circle(image, pt_cog[:2], 5, (255, 0, 0), 2) # draw landmark
...
def main():
    ...
    while cap.isOpened():
        ...
        draw_cog_point_of_only_visible_basic_points(frame, Pose)

        draw_cog_point_of_only_basic_points(frame, Pose)
